...
You can take a peek at this website (https://bit.ly/2NZpTQR) for the formula you'll need to use to calculate the split complementary colours.
Examples
Input:
...
const festivalColours = color1 => {
  // code here!
  h = [];
  h[0] = Math.abs((color1 - 150) +360);
  h[1] = Math.abs((color1 - 210) +360);
